...
server.tool('get-apifox-project-id-and-api-id-from-url', 'Get the project ID and API ID of Apifox from the URL.', {
...
server.tool('get-apifox-api-info', 'Get the info of Apifox API.', {
